...
def train_one_step_kd_feature(net,teacher_net, data, label, optimizer, criterion,temperature = 4,kd_loss_scalar = 0.5,if_accum_grad = False, gradient_mask_tensor = None, lasso_keyword_to_strength=None):
    ...
    import torch.nn as nn
    l2_loss_fn = nn.MSELoss()
    kd_loss = l2_loss_fn(feature, teacher_feature.detach()) * 10
...
def train_main(local_rank,cfg:BaseConfigByEpoch, net=None, train_dataloader=None, val_dataloader=None, show_variables=False, convbuilder=None,
